...
class TripSideScree extends StatefulWidget {
  @override
  _TripSideScreeState createState() => _TripSideScreeState();
}

class _TripSideScreeState extends State<TripSideScree> {
  bool showTrip = false;
  double all_rating;
  var AllData;
  ...
  getNot() async {
    ...
    for (var i = 0; i < tripList.tripListData.length; i++) {
      ...
      String dateee = '${input.year}-${input.month}-${input.day.toString().length == 1 ? '0${input.day}' : '${input.day}'}';

print('tripList.tripListData ${tripList.tripListData}');
      if (FiteredData.where((element) {
        print('issue ${element['dateStart']}');
...
// }
        ...
        print('else');
       if(FiteredData.where((element) => element['dateStart'] == dateee).length > 0 ){
       }
       else{
      ...
      var matchData = tripList.tripListData.where((element) {
        ...
        DateTime check =
            DateTime.parse(element['dateStart']);
              String dateeee = '${check.year}-${check.month}-${check.day.toString().length == 1 ? '0${check.day}' : '${check.day}'}';
                ...
                children: [
                  ...
                  ListView.builder(
                      ...
                      itemBuilder: (context, i) {
                        ...
                        final d4 = Duration(seconds: timE);
                      ...
                      pointers: <GaugePointer>[
                        RangePointer(
                            ...
                            gradient: const SweepGradient(
                                colors: <Color>[Color(0xffFA391B), Color(0xffF7E42A),Color(0xff52C94C),Color(0xff01a8dd)],
                          ...
                          text: new TextSpan(
                            ...
                            children: <TextSpan>[
                              new TextSpan(
                                  ...
                                  style: new TextStyle(
                                      fontSize: 40, fontFamily: 'PoppinsRegular')),
                              new TextSpan(
                                  text: ' /5',
                                  style: TextStyle(
                                      fontSize: 25,
...
class Circular_arc extends StatefulWidget {
  final double all_rating;
  const Circular_arc({Key key, this.all_rating}) : super(key: key);
...
class _Circular_arcState extends State<Circular_arc>
  ...
  void initState() {
    ...
    animation = Tween<double>(begin: 0.0, end: widget.all_rating / 2)
              ...
              children: [
                ...
                RichText(
                  text: new TextSpan(
                    ...
                    children: <TextSpan>[
                      new TextSpan(
                          text: widget.all_rating.toStringAsFixed(1),
                          style: new TextStyle(
                              fontSize: 40, fontFamily: 'PoppinsRegular')),
                      new TextSpan(
                          text: ' /5',
